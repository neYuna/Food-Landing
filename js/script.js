window.addEventListener("DOMContentLoaded", () => {
  ...
  function bindPostData(form) {
    form.addEventListener("submit", (e) => {
      ...
      //   object[key] = value;
      // });
      // после этого делали JSON.stringify(object) после урла в фэче в качестве дэйты
  ...
  //Простая версия написания слайдера
  // let slideIndex = 1;
  // let offset = 0;
  // const parentSlideImg = document.querySelector(".offer__slider-wrapper"),
